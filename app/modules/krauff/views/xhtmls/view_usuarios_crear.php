                            ...
                            <div class="table-responsive">
                                <table border="0"  class="table table-striped table-condensed">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo $Formulario->addObject("MenuList", "codperfil", $arr_perfiles, "", "class='form-control'  tabindex='1' style='cursor:pointer;'"); ?></td>
                                            <td colspan="2"><input type="text" class="form-control validate[required,minSize[1],maxSize[150]]" id="nombres" name="nombres" size="70" tabindex="2"/></td>
                                            <td><?php echo $Formulario->addObject("MenuList", "tipodoc", $DOM["TIPODOC"], "1", "class='form-control' tabindex='3' style='cursor:pointer;'"); ?></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control validate[required,custom[integer],minSize[1],maxSize[30]]" id="documento" name="documento" size="20" tabindex="4"/></td>
                                            <td><?php echo $Formulario->addObject("MenuList", "genero", $DOM["GENERO"], "1", "class='form-control' tabindex='5' style='cursor:pointer;'"); ?></td>
                                ...
                                <table border="0" width="95%" class="table table-striped table-condensed">
                                    <tbody>          
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3"><?php if ($DOM["USER_ID"] == -1) {
    echo $Formulario->addObject("MenuList", "codempresa", $arrayEmpresa, "", "class='form-control' tabindex='15'");
} ?></td>
                                        </tr>
                                    </tbody>
                                </table>
