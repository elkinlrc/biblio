                                ...
                                <div class="table-responsive"> 
                                    <table border="0" wedth="95%" class="table table-hover table-condensed">
                                        <tr>
                                            ...
                                            <td width="5%"><?php echo $Formulario->addObject("MenuList", "nomcampos", $DOM["COMBOUSUARIOS"], $combo_campos, "onchange=\"javascript:limpiarbusqueda();\"class='form-control' style='cursor:pointer;'") ?></td>
