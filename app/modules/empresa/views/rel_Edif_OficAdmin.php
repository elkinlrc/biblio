...
$Face->set_name("Administrar Edificios");

$Face->add_navigation("Inicio", "index.php");
$Face->add_navigation("Administrar Edificios", "#");
...
//$facadee = new Modules_Empresa_Model_Oficinasfacade();
...
$registros = $facadeEdificios->load_all_Join($rsNumRows, $limit_numrows, $page, $Data);
