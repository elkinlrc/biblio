                ...
                <div class="widget stacked">
                    ...
                    <div class="widget-content">
                        <form id="frm" name="frm" method="POST" action="traceo.php" onsubmit="javascript:return checkform('frm');">
                            ...
                            <input type="hidden" id="action" name="action" value="crearRELOFICINA" />
                            ...
                            <table class="table table-bordered table-highlight">
                                ...
                                <tbody>
                                    <tr>
                                        <td>Seleccionar Edificios</td>
                                        <td> <?php
                                        echo $formulario->addObject("MenuList", "codedificio",$arr_equipos, "", "", "");
                                         ?> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Seleccionar Oficinas</td>
                                      <td> <?php
