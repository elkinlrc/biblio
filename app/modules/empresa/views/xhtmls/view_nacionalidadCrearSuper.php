                ...
                <div class="widget stacked">
                    ...
                    <div class="widget-content">
                        <form id="frm" name="frm" method="POST" action="traceo.php" onsubmit="javascript:return checkform('frm');">
                            ...
                            <input type="hidden" id="action" name="action" value="crearNacionalidadSuper" />
                            <input type="hidden" id="controller" name="controller" value="empresa/nacionalidadcontroller" />
                            <table class="table table-bordered table-highlight">
                                <thead>
                                    <tr>
                                        <th colspan="2">Nueva Nacionalidad</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>Nacionalidad</td>
                                        <td><input type="text" id="nacionalidad" name="nacionalidad" class="form-control validate[required, minSize[4]]" size="30"/></td>
                                    </tr>
                                    <tr>
