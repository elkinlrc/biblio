                ...
                <div class="widget stacked">
                    ...
                    <div class="widget-content">
                        <form id="frm" name="frm" method="POST" action="traceo.php" onsubmit="javascript:return checkform('frm');">
                            ...
                            <input type="hidden" id="action" name="action" value="crearPerfilSuper" />
                            ...
                            <table class="table table-bordered table-highlight">
                                ...
                                <tbody> 
                                    <tr>
                                        <td>perfil</td>
                                        <td><input type="text"  id="perfil" name="perfil" class="form-control validate[required, minSize[4]]" size="30"/></td>
                                    </tr>
