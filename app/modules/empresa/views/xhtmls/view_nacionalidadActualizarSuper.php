                ...
                <div class="widget stacked">
                    ...
                    <div class="widget-content">
                        <form id="frm" name="frm" method="POST" action="traceo.php" onsubmit="javascript:return checkform('frm');">
                            ...
                            <input type="hidden" id="action" name="action" value="actualizarNacionalidadSuper" />
                            <input type="hidden" id="controller" name="controller" value="empresa/nacionalidadcontroller" />
                             <input type="hidden" id="codnacionalidad" name="codnacionalidad" value="<?php echo $Nacionalidades->get_codnacionalidad();?>" />
                            <table class="table table-bordered table-highlight">
                                <thead>
                                    <tr>
                                        <th colspan="2">Actualizacion Nacionalidad</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td>Nacionalidad</td>
                                        <td><input type="text" value="<?php echo $Nacionalidades->get_nacionalidad(); ?>" id="nacionalidad" name="nacionalidad" class="form-control validate[required, minSize[4]]" size="30"/></td>
                                    </tr>
                                    <tr>
