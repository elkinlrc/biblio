            ...
            <div class="span12">
                <div class="widget stacked">
                    <div class="widget-header">
                        ...
                        <h3>Administrar-Súper</h3>
                          <a href="edificiosCrearSuper.php" class="abrirFlotanteSuper">Nuevo Edificio</a>
                    </div>
                        ...
                        <table class="table table-bordered table-highlight">
                            ...
                            <tbody>
                                ...
                                foreach ($registros as $indice => $campo){
                                    $parametros->add("action", "eliminarEdificiosSuper");
                                    ...
                                    echo "<a class=\"abrirFlotanteSuper\" href=\"edificiosActualizarSuper.php?{$url_actualizar}\"><i class=\"icon-edit\" /></a>";
                                    echo "</td>";
                                    echo "<td style=\"text-align: center\">";
