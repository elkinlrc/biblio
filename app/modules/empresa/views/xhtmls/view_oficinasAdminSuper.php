            ...
            <div class="span12">
                <div class="widget stacked">
                    <div class="widget-header">
                        ...
                        <h3>Administrar Oficinas Súper</h3>
                        
                         <a href="oficinasCrearSuper.php" class="abrirFlotanteSuper "> Nueva Oficina</a>
                        ...
                        <table class="table table-bordered table-highlight">
                            ...
                            <tbody>
                                ...
                                foreach ($registros as $indice => $campo){
                                    $parametros->add("action", "eliminarOficinaSuper");
                                    ...
                                    echo "<a class=\"abrirFlotanteSuper\" href=\"oficinasActualizarSuper.php?{$url_actualizar}\"><i class=\"icon-edit\" /></a>";
                                    echo "</td>";
                                    echo "<td style=\"text-align: center\">";
