                        ...
                        <table class="table table-bordered table-highlight">
                            <thead>
                                <tr>
                                    ...
                                    <th width="50%" style="text-align: center">Usuarios</th>
                            ...
                            <tbody>
                                ...
                                foreach ($registros as $indice => $campo) {
                                    $parametros->add("action", "eliminarRELna");
                                    ...
                                    echo "<a href=\"nacionalidadActualizar.php?{$url_actualizar}\"><i class=\"icon-edit\" /></a>";
                                    echo "</td>";
                                    echo "<td style=\"text-align: center\">";
