...
class Modules_Biblio_Controllers_MetadatosController {
    ...
    private function crear() {
        ...
        $this->_parameters->add("codmetadato", $obj->get_codmetadato());
    ...
    private function eliminar() {
        ...
        $this->_parameters->delete_all();
        $this->_parameters->add("msg", $mensaje);
        $this->_parameters->add("codigo", $obj->get_codmetadato());
