...
class Modules_Biblio_Controllers_SedesController {
    ...
    private function crear() {
        $obj = new Modules_Biblio_Model_Sedes();
        $objo = $this->_parameters->set_object($obj);
        $facade = new Modules_Biblio_Model_SedesFacade();
        ...
        $this->_parameters->add("codautor", $obj->get_codsede());
    ...
    private function eliminar() {
        ...
        $this->_parameters->delete_all();
        $this->_parameters->add("msg", $mensaje);
        $this->_parameters->add("codigo", $obj->get_codsede());
