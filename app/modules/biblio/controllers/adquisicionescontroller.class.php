...
class Modules_Biblio_Controllers_AdquisicionesController {
    ...
    private function crear() {
        $obj = new Modules_Biblio_Model_Adquisiciones();
        $objo = $this->_parameters->set_object($obj);
        $facade = new Modules_Biblio_Model_AdquisicionesFacade();
        ...
        $this->_parameters->add("codadquisicion", $obj->get_codadquisicion());
    ...
    private function eliminar() {
        ...
        $this->_parameters->delete_all();
        $this->_parameters->add("msg", $mensaje);
        $this->_parameters->add("codigo", $obj->get_codadquisicion());
