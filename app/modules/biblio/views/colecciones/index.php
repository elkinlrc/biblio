...
//$facadeColecciones = new Modules_Empresa_Model_Edificiosfacade;
$facade = new Modules_Biblio_Model_ColeccionesFacade();
$facade->add_searchField("1","a.codcoleccion");
$facade->add_searchField("2","a.coleccion");
...
$Face->set_name("Listar Colecciones ");

$Face->add_navigation("Inicio", "index.php");
$Face->add_navigation("Listar Colecciones", "#");
