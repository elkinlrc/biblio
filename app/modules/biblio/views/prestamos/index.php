...
//$facadePrestamos = new Modules_Empresa_Model_Edificiosfacade;
$facade = new Modules_Biblio_Model_PrestamosFacade();
$facade->add_searchField("1","a.codprestamo");
...
$Face->set_name("Listar Prestamos ");

$Face->add_navigation("Inicio", "index.php");
$Face->add_navigation("Listar Prestamos", "#");
