...
$DOM["SECURITY_ID"] = array("MNTO_ADQUI");
...
//$facadeAdquisiciones = new Modules_Empresa_Model_Edificiosfacade;
$facade = new Modules_Biblio_Model_AdquisicionesFacade();
$facade->add_searchField("1","a.codadquisicion");
...
$Face->set_name("Listar Adquisiciones ");

$Face->add_navigation("Inicio", "index.php");
$Face->add_navigation("Listar Adquisiciones", "#");
