...
/**
 * Description of librosmetafacade
 *
 * @author elkinlrc
 */
class Modules_Biblio_Model_LibrosmetaFacade implements Moon2_Interfaces_MandatoryModel {
    
    
    private $_objdb;
    
    function __construct() {
          $this->_objdb= new Modules_Biblio_ModelDb_Librosmetadb();
